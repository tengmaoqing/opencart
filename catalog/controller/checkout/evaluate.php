<?php
class ControllerCheckoutEvaluate extends Controller {
    ...
    public function index() {
        ...
        $cache_key = 'live_price_update'. md5($product_id . $quantity. $options_hash . $this->customer->getId() . $this->session->data['language']);
